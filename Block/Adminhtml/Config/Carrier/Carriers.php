 ...
 */
namespace TIG\Vendiro\Block\Adminhtml\Config\Carrier;
...
class Carriers extends Field
{
    ...
    protected $_template = 'TIG_Vendiro::shipment/carriers.phtml';
    ...
    {
        return $this->getUrl('tig_vendiro/config_carrier/Carriers');
    }
