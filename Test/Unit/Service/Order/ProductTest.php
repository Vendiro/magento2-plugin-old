    ...
    public function getBySkuProvider()
    {
        return [
            ...
            'product id not found' => [
                false,
                15,
                'The order could not be exported. The product that was requested wasn\'t found.'
            ],
            'product not in stock' => [
                987,
                0,
                'The order could not be exported. The product that was requested is not in stock.'
            ]
        ];
    }
